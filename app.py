...
app = Flask(__name__)
app.url_map.strict_slashes = False  # Optional, but prevents routing issues on Vercel

@app.route('/', methods=['GET'])
def home():
    return jsonify({"message": "✅ Flask is working. Use /like?uid=XXXX&server_name=IND"})
...
def handle_requests():
    ...
    def process_request():
        ...
        before_like = data['AccountInfo'].get('Likes', 0)
